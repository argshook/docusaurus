...
:::warning The `fallback` prop is a callback, and **not a React functional component**. You can't use React hooks inside this callback. :::
...
:::warning Use this hook instead of `typeof windows !== 'undefined'` in React rendering logic.
...
:::warning **Don't use it for regular links!**
...
:::warning For React rendering logic, use [`useIsBrowser()`](#useIsBrowser) or [`<BrowserOnly>`](#browseronly) instead. :::
